      ...
      >
        <div className="mx-auto w-full max-w-[1280px] px-4 md:px-10">
          <header className="flex h-16 items-center justify-between gap-4">
            <Link
              href="/"
              aria-label="Harbor Intelligence home"
            ...
            <nav aria-label="Main" className="hidden flex-1 items-center justify-end gap-1 lg:flex">
              ...
              <div className="ml-3 flex items-center gap-2">
                <Link
                  href="/contact"
                  className="relative inline-flex h-8 min-w-8 flex-none cursor-pointer items-center justify-center gap-2 rounded-3xl bg-primary px-3.5 font-display text-[15px] font-semibold text-white transition-all duration-200 hover:rounded-none hover:bg-black hover:text-white"
                >
                  Book a call
                </Link>
              </div>
