      ...
      <div className="relative mx-auto max-w-[1280px] px-6 py-24 md:px-10 md:py-32">
        ...
        <div className="mt-8 flex flex-col items-start gap-10 md:flex-row md:items-end md:justify-between">
          <h2 className="max-w-[720px] font-display text-[40px] font-semibold leading-[1.02] tracking-[-0.035em] text-white md:text-[68px]">
            Find your highest-ROI
            <br />
            AI opportunity <span className="text-primary">this quarter.</span>
          </h2>
          <div className="flex flex-col gap-4 md:items-end">
            <p className="max-w-sm text-[15px] leading-relaxed text-stone-400">
              Start with a 30-minute walkthrough of your operations. We leave you with a
              prioritized list of workflows where AI creates immediate ROI — even if we never
              work together.
            </p>
            <div className="flex flex-wrap gap-3">
              <CtaButton href="/contact" variant="primary-dark" icon={ArrowRight}>
                Book an AI Workflow Audit
              </CtaButton>
              <CtaButton href="#how-it-works" variant="secondary-dark">
                See our approach
              </CtaButton>
            </div>
          </div>
