...
export function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="relative overflow-hidden bg-neutral-950 text-stone-100"
    >
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-[1280px] px-6 py-24 md:px-10 md:py-32">
        <div className="max-w-3xl">
          ...
          <div className="mt-6">
            <SectionTitle
              lead="One partner between your business"
              emph="and every AI capability."
              tone="dark"
            />
          </div>
          <SectionLead tone="dark">
            We start by understanding how your company actually runs. Then we design AI systems
            around your existing operations, integrate them into the tools your team already
            uses, and measure the outcome — time saved, accuracy gained, capacity unlocked.
          </SectionLead>
        </div>
