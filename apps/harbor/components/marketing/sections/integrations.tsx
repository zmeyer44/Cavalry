    ...
    <section className="bg-stone-50">
      <div className="mx-auto max-w-[1280px] px-6 py-20 md:px-10 md:py-24">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <Eyebrow tone="primary">Integrates into the systems your team already uses</Eyebrow>
          <p className="max-w-sm text-[14.5px] leading-relaxed text-stone-500">
            We modernize legacy processes without forcing you to replace your tech stack. AI
            lands inside your CRM, helpdesk, ERP, and knowledge base — wherever the work
            actually happens.
          </p>
        </div>
